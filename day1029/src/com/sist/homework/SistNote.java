...
public class SistNote extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(cmd.equals("새파일")) {
			if(fileName.equals("제목없음")) {
				int a = JOptionPane.showConfirmDialog(this, "저장하시겠습니까?", "저장" ,JOptionPane.YES_NO_OPTION);
			...
			try {
				...
				//다이얼로그에서 "취소"를 누르지 않고 "열기"를 눌렀을 때 파일의 내용을 읽어오는 처리를 하도록 함
				if(re == 0) {
